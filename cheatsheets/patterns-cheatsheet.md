...
**Reference:**
[Patterns.dev](https://www.patterns.dev/vanilla/dynamic-import)
Книга "Погружение в паттерны проектирования [2018] Александр Швец"
...
## Адаптер
Cтруктурный паттерн проектирования,
